...
/**
 * Intercepts the https request once and checks if the Authorization header is valid
 *
 * @author basbroerse
 */
@Component
public class JwtTokenFilter extends OncePerRequestFilter  {
    ...
    protected void doFilterInternal(
        ...
        UserDetails userDetails = userRepository.findByEmail(jwtTokenUtil.getEmail(token));
